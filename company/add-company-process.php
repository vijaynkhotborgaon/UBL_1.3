...
$filename = "../images/company/big/".$strip_Company_Name."_". $strip_Company_Logo;
...
echo $mailspoc="<p><b>Hi ".$spocname1."</b>,</p><p>Your Company is successfully registered on <b>Disclose Without Fear!</b></p>
<p>Your contract is valid from <b>".$row1['fromdate']."</b> to <b> ".$row1['tilldate']."</b></p>
<p>Below is the url for submit <b>complaint for the employers</b></p><p><a href='".$mainurl."company/".$unique_url."' target='_blank' style='color:#4E9258;'>".$mainurl."company/".$unique_url."</a></p><p>Below is the <b>url and login details</b> for View and Update the Complaints</p><p>URL: <a href='".$mainurl."spoc/".$unique_url."' target='_blank' style='color:#4E9258;'>".$mainurl."spoc/".$unique_url."</a><br>Username: ".$spocuname1."<br>Password: ".$spocpword1."</p>";
...
$headers .= "Content-type: text/html; charset=iso-8859-1" . "\r\n";
$headers .= "From: " .strip_tags($frommail) . "\r\n" .
"Reply-To: $mainemail" .strip_tags($frommail) . "\r\n" .
...
$result6 = @mysql_query($qry6);
echo $mailspoc="<p><b>Hi".$spocname2."</b>,</p><p>Your Company is successfully registered on <b>Disclose Without Fear!</b></p>
...
$result6 = @mysql_query($qry6);
echo $mailspoc="<p><b>Hi".$spocname3."</b>,</p><p>Your Company is successfully registered on <b>Disclose Without Fear!</b></p>
...
$result6 = @mysql_query($qry6);
echo $mailspoc="<p><b>Hi".$spocname4."</b>,</p><p>Your Company is successfully registered on <b>Disclose Without Fear!</b></p>
...
$result6 = @mysql_query($qry6);
echo $mailspoc="<p><b>Hi".$spocname5."</b>,</p><p>Your Company is successfully registered on <b>Disclose Without Fear!</b></p>
