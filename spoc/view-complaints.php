...
<article>
<!--<a href="<?php //echo $mainurl; ?>spoc/pdf-full-details-test.php?companyurl=<?php //echo $_GET['companyurl']; ?>&companyid=<?php //echo $companyid; ?>&year=<?php //echo $year; ?>&month=<?php //echo $month; ?>" style="display:block; margin-bottom:10px; float:left;"> Download Report</a> -->

<div class="logo-image-1">
<h1>
<a href="<?php echo $mainurl; ?>spoc/pdf-full-details-test.php?companyurl=<?php echo $_GET['companyurl']; ?>&companyid=<?php echo $companyid; ?>&year=<?php echo $year; ?>&month=<?php echo $month; ?>" title="Download Report" target="_blank">
...
<form action="view-complaints" method="post" class="filter">
...
<option value="09"<?php if($month=='09'){ ?> selected<?php } ?>>Sept</option>
