...
<h1>
<a href="<?php echo $mainurl; ?>spoc/pdf-full-details-1-test.php?companyurl=<?php echo $_GET['companyurl']; ?>&companyid=<?php echo $companyid; ?>&year=<?php echo $year; ?>&month=<?php echo $month; ?>" title="Download Report" target="_blank">
...
<form action="closed-complaints" method="post" class="filter">
...
$result = mysql_query("SELECT * FROM complaints where company_id=$companyid AND created_on>='$start' AND created_on<='$end' AND status=2 AND cat_id=$cat ORDER BY complaint_id DESC");
if(mysql_num_rows($result)==0)
	{?>
      </br></br><div id="system-message">
<div class="alert alert-message">
...
$result = mysql_query("SELECT * FROM complaints where company_id=$companyid  AND status=2 AND cat_id=$cat ORDER BY complaint_id DESC");
if(mysql_num_rows($result)==0)
	{?>
      </br></br><div id="system-message">
<div class="alert alert-message">
