...
<div style="clear:both;"><pre style="background-color:#EFF5FA;word-wrap: break-word;display: block;"><?php echo $row['detail']; ?></pre></div>
...
<?php } else { ?>
<div style="clear:both;"><pre style="background-color:#EFF5FA;"><?php echo $row12['msg']; ?></pre></div>
<?php } ?>
