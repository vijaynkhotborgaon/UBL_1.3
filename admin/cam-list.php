...
<td colspan="6"><h4 style="float:left;"><strong>CAM Lists</strong></h4><span style="float:right;"><a href="add-new-cam.php"><img src="../images/user_add.png" alt="Add New CAM" /></a></span>
