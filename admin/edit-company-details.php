...
jQuery("#name_of_spoc").validate({
expression: "if (VAL) return true; else return false;",
message: "Please enter Name of SPOC"
});
jQuery("#email_spoc").validate({
...
jQuery("#ph_no").validate({
expression: "if (VAL) return true; else return false;",
message: "Please enter SPOC Phone Number"
});
...
<input type="hidden" value="<?php echo $row2['clogo']; ?>" name="image_logo" id="image_logo">
...
<legend>Edit SPOC Details</legend>
<p>
<label>Name</label>
<input type="text" name="name_of_spoc" id="name_of_spoc" value="<?php echo $row['cperson']; ?>"></p>

<p>
<label>Email</label>
<input type="text" name="email_spoc" id="email_spoc" value="<?php echo $row['cemail']; ?>"></p>

<p>
<label>Phone Number</label>
<input type="text" name="ph_no" id="ph_no" value="<?php echo $row['cphone']; ?>"></p>

<p>
<label>Designation</label>
<input type="text" name="designation" id="designation" value="<?php echo $row['cdesignation']; ?>"></p>

<?php
$res = mysql_query("SELECT * FROM company_spoc where company_id=".$row2['company_id']);
...
<input type="text" name="uname" id="uname" value="<?php echo $r['uname']; ?>"></p>
...
<input name="company_id" type="hidden" value="<?php echo $r['company_id']; ?>">


<a href="registered-company.php"><img style="float:left;" src="../images/list.png" alt="Registered Company" /></a><input name="Submit" type="submit" class="fSubmit" value="Submit">
</form>
</div>
</article>
<!-- //Article -->
