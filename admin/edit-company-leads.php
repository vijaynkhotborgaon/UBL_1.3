...
<td><input name="activefrom" id="activefrom" class="datepicker" type="text" style="cursor:pointer;" value="<?php echo $rowcontract['fromdate']; ?>" readonly></td>
</tr>
<tr>
<td width="150"><strong>Active Till</strong></td>
<td><input name="activetill" id="activetill" class="datepicker" type="text" style="cursor:pointer;" value="<?php echo $rowcontract['tilldate']; ?>" readonly></td>
</tr>
<tr>
<td>&nbsp;</td>
