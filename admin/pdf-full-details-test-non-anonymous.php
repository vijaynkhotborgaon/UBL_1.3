...
$html.='<div style="margin-bottom:10px;width:100%;height:auto;background-color:#00B0F0"><p style="margin-bottom:2px;margin-top:2px;color:#FFFFFF;">Complaint Details</p></div><div style="margin-top:-5px;margin-bottom:-5px;width:100%;height:auto;border:1px solid #6E6E6E; word-wrap: break-word;display: block;"><pre style="margin-left:10px;margin-right:5px;white-space: pre-wrap;">'.$row["detail"].'</pre></div></div>';
