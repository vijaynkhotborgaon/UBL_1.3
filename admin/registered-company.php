...
<td><a href="<?php echo $mainurl; ?>company/<?php echo $row4['unique_url']; ?>/speak_up/" target="_blank" style="word-wrap: break-word; width:220px; display:block;"><?php echo $mainurl; ?>company/<?php echo $row4['unique_url']; ?></a></td>

<!--<td><a href="<?php //echo $mainurl; ?>speakup/next?q=VGh1IEF1ZyAwNiAyMDE1IDEzOjQ5OjIxIEdNVCswNTMwIChJbmRpYSBTdGFuZGFyZCBUaW1lKQ" target="_blank" style="word-wrap: break-word; width:220px; display:block;"><?php //echo $mainurl; ?>company/<?php //echo $row4['unique_url']; ?></a></td>-->
