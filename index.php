...
<!--<p style="text-align: center;"><a href="#" title="Send your Inquiries.."><img style="margin-top:0px;" alt="" src="images/contact.png"></a><a href="feedback.php" title="Send your Inquiries.."><img style="margin-top:0px;" alt="" src="images/feedback.png"></a></p>-->
		...
		<div class="span6" >
<p style="text-align: right; height:100px;"><a title="Admin Login" href="admin/"><img style="margin: 5px 20px;" src="images/admin_login.png" alt="Admin Login" /></a><a title="CAM Login" href="cam/"><img style="margin: 5px 20px;" src="images/cam_login.png" alt="CAM Login" /></a><a title="TS Login" href="ts/"><img style="margin: 5px 20px;" src="images/ts_login.png" alt="TS Login" /></a></p>
</div>
	</div>
