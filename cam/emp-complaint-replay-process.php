...
if ($_FILES["attachment"]["name"]!='') 
   ...
   move_uploaded_file($_FILES["attachment"]["tmp_name"], "../company/doc/" . $attachment);
}else {
	$attachment='';
}


	$qry = "INSERT INTO complaints_reply(complaint_id, user_id, status, msg, attachment, created_on) VALUES('$complaint_id','100','6','$comments','$attachment',NOW())";
